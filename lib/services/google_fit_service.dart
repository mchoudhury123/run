...
class GoogleFitService {
  ...
  // Types of data to request from Google Fit
  ...
  // Request authorization for Google Fit data
  Future<bool> requestAuthorization() async {
    ...
    try {
      ...
      debugPrint('Google Fit data authorization granted: $granted');
      return granted;
    } catch (e) {
      debugPrint('Error requesting Google Fit authorization: $e');
      return false;
    }
  }
  ...
  Future<double> getDistanceForDay(DateTime date) async {
    try {
      ...
      debugPrint('Error getting distance from Google Fit: $e');
      return 0;
    }
  }
